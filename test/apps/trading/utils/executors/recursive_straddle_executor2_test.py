...
from apps.trading.utils.executors import RecursiveStraddleExecutor2
from lib.network.oanda import Trader
from lib.utils.logger import Logger


class RecursiveStraddleExecutor2Test(unittest.TestCase):
	...
	def test_live_order(self):
		...
		while True:
			...
			for b in [upper_take_profit, lower_take_profit]:
